...
<body class="controller-<?php echo $this->request->controller; ?>">
    <div class="skeleton">
        ...
        <footer class="foot">
            <div class="copyright">
                <p><?php printf(__d('admin', 'Powered by the %s v%s'), $this->Html->link('Admin Plugin', 'http://milesj.me/code/cakephp/admin'), mb_strtoupper($config['Admin']['version'])); ?><br>
                &copy; 2014 Association for Computer Intelligence Integration &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a></p>
